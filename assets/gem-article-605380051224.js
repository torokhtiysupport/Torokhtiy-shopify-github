...
(function( jQuery ){
  // var $module = jQuery('#m-1687198449417').children('.module');
  // You can add custom Javascript code right here.
})( window.GemQuery || jQuery );
    ...
    (function( jQuery ){
  var $module = jQuery('#m-1701393555597').children('.module');
  ...
  if(mode == 'dev') {
    var moduleId = "1701393555597";
    var moduleIdSlug = moduleId.toString().replace(/-/g, '');
    if (moduleIdSlug == "1701393555597") {
      window.getTab1701393555597 = function() {
    ...
    (function( jQuery ){
  var $module = jQuery('#m-1701393583210').children('.module');
  $module.gfV1Popup();

  var mode = jQuery('.gryffeditor').hasClass('editing') ? 'dev' : 'production';
  if(mode == 'dev') {
    var moduleId = "1701393583210";
    var moduleIdSlug = moduleId.toString().replace(/-/g, '');
    if (moduleIdSlug == "1701393583210") {
      window.getPopup1701393583210 = function() {
