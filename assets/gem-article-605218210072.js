...
(function( jQuery ){
  ...
  // You can add custom Javascript code right here.
    ...
    (function( jQuery ){
  // var $module = jQuery('#m-1684798024634').children('.module');
  // You can add custom Javascript code right here.
})( window.GemQuery || jQuery );
  ...
  // You can add custom Javascript code right here.
    ...
    (function( jQuery ){
  var $module = jQuery('#m-1701300709278').children('.module');
  ...
  if(mode == 'dev') {
    var moduleId = "1701300709278";
    var moduleIdSlug = moduleId.toString().replace(/-/g, '');
    if (moduleIdSlug == "1701300709278") {
      window.getTab1701300709278 = function() {
    ...
    (function( jQuery ){
  var $module = jQuery('#m-1701300733576').children('.module');
  $module.gfV1Popup();

  var mode = jQuery('.gryffeditor').hasClass('editing') ? 'dev' : 'production';
  if(mode == 'dev') {
    var moduleId = "1701300733576";
    var moduleIdSlug = moduleId.toString().replace(/-/g, '');
    if (moduleIdSlug == "1701300733576") {
      window.getPopup1701300733576 = function() {
