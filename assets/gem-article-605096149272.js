...
$(document).on("inview", ".rate_bar_wrap", function(event, visible) {
  ...
  // You can add custom Javascript code right here.
    ...
    (function( jQuery ){
  var $module = jQuery('#m-1701298508500').children('.module');
  ...
  if(mode == 'dev') {
    var moduleId = "1701298508500";
    var moduleIdSlug = moduleId.toString().replace(/-/g, '');
    if (moduleIdSlug == "1701298508500") {
      window.getTab1701298508500 = function() {
    ...
    (function( jQuery ){
  var $module = jQuery('#m-1701298526244').children('.module');
  $module.gfV1Popup();

  var mode = jQuery('.gryffeditor').hasClass('editing') ? 'dev' : 'production';
  if(mode == 'dev') {
    var moduleId = "1701298526244";
    var moduleIdSlug = moduleId.toString().replace(/-/g, '');
    if (moduleIdSlug == "1701298526244") {
      window.getPopup1701298526244 = function() {
