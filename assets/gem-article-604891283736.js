...
$(document).on("inview", ".rate_bar_wrap", function(event, visible) {
  ...
  // You can add custom Javascript code right here.
    ...
    (function( jQuery ){
  var $module = jQuery('#m-1705776578770').children('.module');
  ...
  if(mode == 'dev') {
    var moduleId = "1705776578770";
    var moduleIdSlug = moduleId.toString().replace(/-/g, '');
    if (moduleIdSlug == "1705776578770") {
      window.getTab1705776578770 = function() {
    ...
    (function( jQuery ){
  var $module = jQuery('#m-1688746701401').children('.module');
  $module.gfV1Popup();

  var mode = jQuery('.gryffeditor').hasClass('editing') ? 'dev' : 'production';
  if(mode == 'dev') {
    var moduleId = "1688746701401";
    var moduleIdSlug = moduleId.toString().replace(/-/g, '');
    if (moduleIdSlug == "1688746701401") {
      window.getPopup1688746701401 = function() {
