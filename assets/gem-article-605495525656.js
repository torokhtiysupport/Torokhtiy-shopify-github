...
$(document).on("inview", ".rate_bar_wrap", function(event, visible) {
  ...
  // You can add custom Javascript code right here.
    ...
    (function( jQuery ){
  var $module = jQuery('#m-1701211754820').children('.module');
  ...
  if(mode == 'dev') {
    var moduleId = "1701211754820";
    var moduleIdSlug = moduleId.toString().replace(/-/g, '');
    if (moduleIdSlug == "1701211754820") {
      window.getTab1701211754820 = function() {
    ...
    (function( jQuery ){
  var $module = jQuery('#m-1701211851571').children('.module');
  $module.gfV1Popup();

  var mode = jQuery('.gryffeditor').hasClass('editing') ? 'dev' : 'production';
  if(mode == 'dev') {
    var moduleId = "1701211851571";
    var moduleIdSlug = moduleId.toString().replace(/-/g, '');
    if (moduleIdSlug == "1701211851571") {
      window.getPopup1701211851571 = function() {
