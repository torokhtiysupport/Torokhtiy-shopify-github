...
(function( jQuery ){
  ...
  // You can add custom Javascript code right here.
    ...
    (function( jQuery ){
  var $module = jQuery('#m-1701205121313').children('.module');
  ...
  if(mode == 'dev') {
    var moduleId = "1701205121313";
    var moduleIdSlug = moduleId.toString().replace(/-/g, '');
    if (moduleIdSlug == "1701205121313") {
      window.getTab1701205121313 = function() {
    ...
    (function( jQuery ){
  var $module = jQuery('#m-1701209855630').children('.module');
  $module.gfV1Popup();

  var mode = jQuery('.gryffeditor').hasClass('editing') ? 'dev' : 'production';
  if(mode == 'dev') {
    var moduleId = "1701209855630";
    var moduleIdSlug = moduleId.toString().replace(/-/g, '');
    if (moduleIdSlug == "1701209855630") {
      window.getPopup1701209855630 = function() {
