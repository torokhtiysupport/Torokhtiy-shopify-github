...
(function( jQuery ){
  ...
  // You can add custom Javascript code right here.
    ...
    (function( jQuery ){
  var $module = jQuery('#m-1701210756384').children('.module');
  ...
  if(mode == 'dev') {
    var moduleId = "1701210756384";
    var moduleIdSlug = moduleId.toString().replace(/-/g, '');
    if (moduleIdSlug == "1701210756384") {
      window.getTab1701210756384 = function() {
    ...
    (function( jQuery ){
  var $module = jQuery('#m-1701210832462').children('.module');
  $module.gfV1Popup();

  var mode = jQuery('.gryffeditor').hasClass('editing') ? 'dev' : 'production';
  if(mode == 'dev') {
    var moduleId = "1701210832462";
    var moduleIdSlug = moduleId.toString().replace(/-/g, '');
    if (moduleIdSlug == "1701210832462") {
      window.getPopup1701210832462 = function() {
