        ...
        jQuery(function() {
            var $hero = jQuery('#m-1630316190422');
            var $module = jQuery('#m-1630316190422').children('.module');
        ...
        jQuery(function() {
            var $module = jQuery('#m-1570092099473').children('.module');

            var mode = jQuery('.gryffeditor').hasClass('editing') ? 'dev' : 'production';
            if(mode == 'production') { 
                $module.find('button[type="submit"]').on('mouseover', function() {
                    try {
                        localStorage.setItem('gemId', '#m-1570092099473');
                    } catch(err) {}
                });
