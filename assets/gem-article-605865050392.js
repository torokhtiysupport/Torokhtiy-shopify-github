...
$(document).on("inview", ".rate_bar_wrap", function(event, visible) {
  ...
  // You can add custom Javascript code right here.
    ...
    (function( jQuery ){
  var $module = jQuery('#m-1699645062366').children('.module');
  ...
  if(mode == 'dev') {
    var moduleId = "1699645062366";
    var moduleIdSlug = moduleId.toString().replace(/-/g, '');
    if (moduleIdSlug == "1699645062366") {
      window.getTab1699645062366 = function() {
    ...
    (function( jQuery ){
  var $module = jQuery('#m-1699640940007').children('.module');
  $module.gfV1Popup();

  var mode = jQuery('.gryffeditor').hasClass('editing') ? 'dev' : 'production';
  if(mode == 'dev') {
    var moduleId = "1699640940007";
    var moduleIdSlug = moduleId.toString().replace(/-/g, '');
    if (moduleIdSlug == "1699640940007") {
      window.getPopup1699640940007 = function() {
