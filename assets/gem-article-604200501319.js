    ...
    (function( jQuery ){
  // var $module = jQuery('#m-1698653522592').children('.module');
...
(function( jQuery ){
  // var $module = jQuery('#m-1698757918101').children('.module');
  // You can add custom Javascript code right here.
})( window.GemQuery || jQuery );
    
(function( jQuery ){
  // var $module = jQuery('#m-1698757918099').children('.module');
  // You can add custom Javascript code right here.
})( window.GemQuery || jQuery );
    ...
    (function( jQuery ){
  // var $module = jQuery('#m-1698757917998').children('.module');
  // You can add custom Javascript code right here.
})( window.GemQuery || jQuery );
    ...
    (function( jQuery ){
  var $module = jQuery('#m-1698757918121').children('.module');
  ...
  if(mode == 'dev') {
    var moduleId = "1698757918121";
    var moduleIdSlug = moduleId.toString().replace(/-/g, '');
    if (moduleIdSlug == "1698757918121") {
      window.getTab1698757918121 = function() {
    ...
    (function( jQuery ){
  // var $module = jQuery('#m-1683219219930').children('.module');
  // You can add custom Javascript code right here.
})( window.GemQuery || jQuery );
  
    (function( jQuery ){
  var $module = jQuery('#m-1687355626830').children('.module');
  $module.gfV1Popup();

  var mode = jQuery('.gryffeditor').hasClass('editing') ? 'dev' : 'production';
  if(mode == 'dev') {
    var moduleId = "1687355626830";
    var moduleIdSlug = moduleId.toString().replace(/-/g, '');
    if (moduleIdSlug == "1687355626830") {
      window.getPopup1687355626830 = function() {
    ...
    (function( jQuery ){
  var $module = jQuery('#m-1698823803840').children('.module');
  $module.gfV1Popup();

  var mode = jQuery('.gryffeditor').hasClass('editing') ? 'dev' : 'production';
  if(mode == 'dev') {
    var moduleId = "1698823803840";
    var moduleIdSlug = moduleId.toString().replace(/-/g, '');
    if (moduleIdSlug == "1698823803840") {
      window.getPopup1698823803840 = function() {
        return $module.data('gfv1popup');
      }
    }
  }
