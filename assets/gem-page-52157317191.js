...
jQuery(function() {
  ...
  $module.gfV3Product();
        ...
        var $module = jQuery('#m-1590554613514-2').children('.module');
  ...
  var $module = jQuery('#m-1590554613572').children('.module');
});jQuery(function() {
  ...
  var $module = jQuery('#m-1591044875514').children('.module');
  var mode = jQuery('.gryffeditor').hasClass('editing') ? 'dev' : 'production';
  if(jQuery().gfYoutube) {
    $module.gfYoutube();
  }
  ...
  try {
    var $module = jQuery('#m-1591045123913').children('.module');
