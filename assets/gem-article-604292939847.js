    ...
    (function( jQuery ){
  // var $module = jQuery('#m-1668077419610').children('.module');
  // You can add custom Javascript code right here.
})( window.GemQuery || jQuery );
  
(function( jQuery ){
  // var $module = jQuery('#m-1664470859656').children('.module');
  // You can add custom Javascript code right here.
})( window.GemQuery || jQuery );
    ...
    (function( jQuery ){
  // var $module = jQuery('#m-1673715409513').children('.module');
  // You can add custom Javascript code right here.
})( window.GemQuery || jQuery );
    ...
    (function( jQuery ){
  var $module = jQuery('#m-1701123484922').children('.module');
  ...
  if(mode == 'dev') {
    var moduleId = "1701123484922";
    var moduleIdSlug = moduleId.toString().replace(/-/g, '');
    if (moduleIdSlug == "1701123484922") {
      window.getTab1701123484922 = function() {
...
(function( jQuery ){
  ...
  // You can add custom Javascript code right here.
    ...
    (function( jQuery ){
  var $module = jQuery('#m-1701123542955').children('.module');
  $module.gfV1Popup();

  var mode = jQuery('.gryffeditor').hasClass('editing') ? 'dev' : 'production';
  if(mode == 'dev') {
    var moduleId = "1701123542955";
    var moduleIdSlug = moduleId.toString().replace(/-/g, '');
    if (moduleIdSlug == "1701123542955") {
      window.getPopup1701123542955 = function() {
