  ...
  // You can add custom Javascript code right here.
    ...
    (function( jQuery ){
  var $module = jQuery('#m-1697546169330').children('.module');
  ...
  if(mode == 'dev') {
    var moduleId = "1697546169330";
    var moduleIdSlug = moduleId.toString().replace(/-/g, '');
    if (moduleIdSlug == "1697546169330") {
      window.getTab1697546169330 = function() {
  ...
  if(mode == 'dev') {
    ...
    (function( jQuery ){
  var $module = jQuery('#m-1697715147932').children('.module');
  $module.gfV1Popup();

  var mode = jQuery('.gryffeditor').hasClass('editing') ? 'dev' : 'production';
  if(mode == 'dev') {
    var moduleId = "1697715147932";
    var moduleIdSlug = moduleId.toString().replace(/-/g, '');
    if (moduleIdSlug == "1697715147932") {
      window.getPopup1697715147932 = function() {
        return $module.data('gfv1popup');
      }
    }
  }
