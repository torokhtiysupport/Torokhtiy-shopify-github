...
$(document).on("inview", ".rate_bar_wrap", function(event, visible) {
  ...
  // You can add custom Javascript code right here.
    ...
    (function( jQuery ){
  var $module = jQuery('#m-1701392650965').children('.module');
  ...
  if(mode == 'dev') {
    var moduleId = "1701392650965";
    var moduleIdSlug = moduleId.toString().replace(/-/g, '');
    if (moduleIdSlug == "1701392650965") {
      window.getTab1701392650965 = function() {
    ...
    (function( jQuery ){
  var $module = jQuery('#m-1701392670468').children('.module');
  $module.gfV1Popup();

  var mode = jQuery('.gryffeditor').hasClass('editing') ? 'dev' : 'production';
  if(mode == 'dev') {
    var moduleId = "1701392670468";
    var moduleIdSlug = moduleId.toString().replace(/-/g, '');
    if (moduleIdSlug == "1701392670468") {
      window.getPopup1701392670468 = function() {
