    ...
    (function( jQuery ){
  // var $module = jQuery('#m-1673649749657').children('.module');
  // You can add custom Javascript code right here.
})( window.GemQuery || jQuery );
  
(function( jQuery ){
  // var $module = jQuery('#m-1667727758710').children('.module');
  // You can add custom Javascript code right here.
})( window.GemQuery || jQuery );
...
(function( jQuery ){
  ...
  // You can add custom Javascript code right here.
    ...
    (function( jQuery ){
  var $module = jQuery('#m-1700567842246').children('.module');
  ...
  if(mode == 'dev') {
    var moduleId = "1700567842246";
    var moduleIdSlug = moduleId.toString().replace(/-/g, '');
    if (moduleIdSlug == "1700567842246") {
      window.getTab1700567842246 = function() {
    ...
    (function( jQuery ){
  var $module = jQuery('#m-1700567892904').children('.module');
  $module.gfV1Popup();

  var mode = jQuery('.gryffeditor').hasClass('editing') ? 'dev' : 'production';
  if(mode == 'dev') {
    var moduleId = "1700567892904";
    var moduleIdSlug = moduleId.toString().replace(/-/g, '');
    if (moduleIdSlug == "1700567892904") {
      window.getPopup1700567892904 = function() {
