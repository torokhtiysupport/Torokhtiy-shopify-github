...
$(document).on("inview", ".rate_bar_wrap", function(event, visible) {
  ...
  // You can add custom Javascript code right here.
    ...
    (function( jQuery ){
  var $module = jQuery('#m-1701392447019').children('.module');
  ...
  if(mode == 'dev') {
    var moduleId = "1701392447019";
    var moduleIdSlug = moduleId.toString().replace(/-/g, '');
    if (moduleIdSlug == "1701392447019") {
      window.getTab1701392447019 = function() {
...
$(document).on("inview", ".rate_bar_wrap", function(event, visible) {
    ...
    (function( jQuery ){
  var $module = jQuery('#m-1701392470983').children('.module');
  $module.gfV1Popup();

  var mode = jQuery('.gryffeditor').hasClass('editing') ? 'dev' : 'production';
  if(mode == 'dev') {
    var moduleId = "1701392470983";
    var moduleIdSlug = moduleId.toString().replace(/-/g, '');
    if (moduleIdSlug == "1701392470983") {
      window.getPopup1701392470983 = function() {
