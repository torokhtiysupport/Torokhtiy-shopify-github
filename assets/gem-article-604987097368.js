...
$(document).on("inview", ".rate_bar_wrap", function(event, visible) {
  ...
  // You can add custom Javascript code right here.
    ...
    (function( jQuery ){
  var $module = jQuery('#m-1701296670688').children('.module');
  ...
  if(mode == 'dev') {
    var moduleId = "1701296670688";
    var moduleIdSlug = moduleId.toString().replace(/-/g, '');
    if (moduleIdSlug == "1701296670688") {
      window.getTab1701296670688 = function() {
    ...
    (function( jQuery ){
  var $module = jQuery('#m-1701296680180').children('.module');
  $module.gfV1Popup();

  var mode = jQuery('.gryffeditor').hasClass('editing') ? 'dev' : 'production';
  if(mode == 'dev') {
    var moduleId = "1701296680180";
    var moduleIdSlug = moduleId.toString().replace(/-/g, '');
    if (moduleIdSlug == "1701296680180") {
      window.getPopup1701296680180 = function() {
