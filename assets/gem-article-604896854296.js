...
$(document).on("inview", ".rate_bar_wrap", function(event, visible) {
  ...
  // You can add custom Javascript code right here.
    ...
    (function( jQuery ){
  var $module = jQuery('#m-1701295500796').children('.module');
  ...
  if(mode == 'dev') {
    var moduleId = "1701295500796";
    var moduleIdSlug = moduleId.toString().replace(/-/g, '');
    if (moduleIdSlug == "1701295500796") {
      window.getTab1701295500796 = function() {
    ...
    (function( jQuery ){
  var $module = jQuery('#m-1701295515307').children('.module');
  $module.gfV1Popup();

  var mode = jQuery('.gryffeditor').hasClass('editing') ? 'dev' : 'production';
  if(mode == 'dev') {
    var moduleId = "1701295515307";
    var moduleIdSlug = moduleId.toString().replace(/-/g, '');
    if (moduleIdSlug == "1701295515307") {
      window.getPopup1701295515307 = function() {
