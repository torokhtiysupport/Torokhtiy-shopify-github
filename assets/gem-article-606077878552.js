...
(function( jQuery ){
  ...
  // You can add custom Javascript code right here.
    ...
    (function( jQuery ){
  var $module = jQuery('#m-1699712330964').children('.module');
  ...
  if(mode == 'dev') {
    var moduleId = "1699712330964";
    var moduleIdSlug = moduleId.toString().replace(/-/g, '');
    if (moduleIdSlug == "1699712330964") {
      window.getTab1699712330964 = function() {
  ...
  if(mode == 'dev') {
    ...
    (function( jQuery ){
  var $module = jQuery('#m-1699859962420').children('.module');
  $module.gfV1Popup();

  var mode = jQuery('.gryffeditor').hasClass('editing') ? 'dev' : 'production';
  if(mode == 'dev') {
    var moduleId = "1699859962420";
    var moduleIdSlug = moduleId.toString().replace(/-/g, '');
    if (moduleIdSlug == "1699859962420") {
      window.getPopup1699859962420 = function() {
        return $module.data('gfv1popup');
      }
    }
  }
