    ...
    (function( jQuery ){
  // var $module = jQuery('#m-1698320024787').children('.module');
...
(function( jQuery ){
  // var $module = jQuery('#m-1698315714170').children('.module');
  // You can add custom Javascript code right here.
})( window.GemQuery || jQuery );
    
(function( jQuery ){
  // var $module = jQuery('#m-1698315714269').children('.module');
  // You can add custom Javascript code right here.
})( window.GemQuery || jQuery );
    
    (function( jQuery ){
  var $module = jQuery('#m-1698322909770').children('.module');
  ...
  if(mode == 'dev') {
    var moduleId = "1698322909770";
    var moduleIdSlug = moduleId.toString().replace(/-/g, '');
    if (moduleIdSlug == "1698322909770") {
      window.getTab1698322909770 = function() {
    ...
    (function( jQuery ){
  // var $module = jQuery('#m-1698333831819').children('.module');
  // You can add custom Javascript code right here.
})( window.GemQuery || jQuery );
    ...
    (function( jQuery ){
  // var $module = jQuery('#m-1698407852063').children('.module');
  // You can add custom Javascript code right here.
})( window.GemQuery || jQuery );
  
    (function( jQuery ){
  var $module = jQuery('#m-1698322999593').children('.module');
  $module.gfV1Popup();

  var mode = jQuery('.gryffeditor').hasClass('editing') ? 'dev' : 'production';
  if(mode == 'dev') {
    var moduleId = "1698322999593";
    var moduleIdSlug = moduleId.toString().replace(/-/g, '');
    if (moduleIdSlug == "1698322999593") {
      window.getPopup1698322999593 = function() {
