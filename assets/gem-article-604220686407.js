...
$(document).on("inview", ".rate_bar_wrap", function(event, visible) {
    ...
    (function( jQuery ){
  // var $module = jQuery('#m-1694093840594').children('.module');
...
(function( jQuery ){
  // var $module = jQuery('#m-1694095245554').children('.module');
  // You can add custom Javascript code right here.
})( window.GemQuery || jQuery );
    (function( jQuery ){
  // var $module = jQuery('#m-1694095245526').children('.module');
  // You can add custom Javascript code right here.
})( window.GemQuery || jQuery );
    (function( jQuery ){
  var $module = jQuery('#m-1700137993358').children('.module');
  ...
  if(mode == 'dev') {
    var moduleId = "1700137993358";
    var moduleIdSlug = moduleId.toString().replace(/-/g, '');
    if (moduleIdSlug == "1700137993358") {
      window.getTab1700137993358 = function() {
    ...
    (function( jQuery ){
  // var $module = jQuery('#m-1694095245505').children('.module');
  // You can add custom Javascript code right here.
})( window.GemQuery || jQuery );
    ...
    (function( jQuery ){
  var $module = jQuery('#m-1700138120619').children('.module');
  $module.gfV1Popup();

  var mode = jQuery('.gryffeditor').hasClass('editing') ? 'dev' : 'production';
  if(mode == 'dev') {
    var moduleId = "1700138120619";
    var moduleIdSlug = moduleId.toString().replace(/-/g, '');
    if (moduleIdSlug == "1700138120619") {
      window.getPopup1700138120619 = function() {
