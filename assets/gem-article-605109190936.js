...
$(document).on("inview", ".rate_bar_wrap", function(event, visible) {
  ...
  // You can add custom Javascript code right here.
    ...
    (function( jQuery ){
  var $module = jQuery('#m-1701298953023').children('.module');
  ...
  if(mode == 'dev') {
    var moduleId = "1701298953023";
    var moduleIdSlug = moduleId.toString().replace(/-/g, '');
    if (moduleIdSlug == "1701298953023") {
      window.getTab1701298953023 = function() {
    ...
    (function( jQuery ){
  var $module = jQuery('#m-1701298972154').children('.module');
  $module.gfV1Popup();

  var mode = jQuery('.gryffeditor').hasClass('editing') ? 'dev' : 'production';
  if(mode == 'dev') {
    var moduleId = "1701298972154";
    var moduleIdSlug = moduleId.toString().replace(/-/g, '');
    if (moduleIdSlug == "1701298972154") {
      window.getPopup1701298972154 = function() {
