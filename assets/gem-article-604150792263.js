...
$(document).on("inview", ".rate_bar_wrap", function(event, visible) {
    ...
    (function( jQuery ){
  // var $module = jQuery('#m-1673647660402').children('.module');
...
(function( jQuery ){
  // var $module = jQuery('#m-1659968255000').children('.module');
  // You can add custom Javascript code right here.
})( window.GemQuery || jQuery );
...
(function( jQuery ){
  // var $module = jQuery('#m-1698779798076').children('.module');
  // You can add custom Javascript code right here.
})( window.GemQuery || jQuery );
    
    (function( jQuery ){
  // var $module = jQuery('#m-1698779798089').children('.module');
  // You can add custom Javascript code right here.
})( window.GemQuery || jQuery );
  
(function( jQuery ){
  // var $module = jQuery('#m-1698779798090').children('.module');
  // You can add custom Javascript code right here.
})( window.GemQuery || jQuery );
    
    (function( jQuery ){
  var $module = jQuery('#m-1698779798104').children('.module');
  ...
  if(mode == 'dev') {
    var moduleId = "1698779798104";
    var moduleIdSlug = moduleId.toString().replace(/-/g, '');
    if (moduleIdSlug == "1698779798104") {
      window.getTab1698779798104 = function() {
    ...
    (function( jQuery ){
  var $module = jQuery('#m-1698775641570').children('.module');
  $module.gfV1Popup();

  var mode = jQuery('.gryffeditor').hasClass('editing') ? 'dev' : 'production';
  if(mode == 'dev') {
    var moduleId = "1698775641570";
    var moduleIdSlug = moduleId.toString().replace(/-/g, '');
    if (moduleIdSlug == "1698775641570") {
      window.getPopup1698775641570 = function() {
