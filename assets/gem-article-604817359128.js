  ...
  // You can add custom Javascript code right here.
    ...
    (function( jQuery ){
  var $module = jQuery('#m-1701291849563').children('.module');
  ...
  if(mode == 'dev') {
    var moduleId = "1701291849563";
    var moduleIdSlug = moduleId.toString().replace(/-/g, '');
    if (moduleIdSlug == "1701291849563") {
      window.getTab1701291849563 = function() {
    ...
    (function( jQuery ){
  var $module = jQuery('#m-1701291911174').children('.module');
  $module.gfV1Popup();

  var mode = jQuery('.gryffeditor').hasClass('editing') ? 'dev' : 'production';
  if(mode == 'dev') {
    var moduleId = "1701291911174";
    var moduleIdSlug = moduleId.toString().replace(/-/g, '');
    if (moduleIdSlug == "1701291911174") {
      window.getPopup1701291911174 = function() {
