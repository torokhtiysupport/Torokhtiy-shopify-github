...
$(document).on("inview", ".rate_bar_wrap", function(event, visible) {
  ...
  // You can add custom Javascript code right here.
    ...
    (function( jQuery ){
  var $module = jQuery('#m-1701432137156').children('.module');
  ...
  if(mode == 'dev') {
    var moduleId = "1701432137156";
    var moduleIdSlug = moduleId.toString().replace(/-/g, '');
    if (moduleIdSlug == "1701432137156") {
      window.getTab1701432137156 = function() {
    ...
    (function( jQuery ){
  var $module = jQuery('#m-1701432182128').children('.module');
  $module.gfV1Popup();

  var mode = jQuery('.gryffeditor').hasClass('editing') ? 'dev' : 'production';
  if(mode == 'dev') {
    var moduleId = "1701432182128";
    var moduleIdSlug = moduleId.toString().replace(/-/g, '');
    if (moduleIdSlug == "1701432182128") {
      window.getPopup1701432182128 = function() {
