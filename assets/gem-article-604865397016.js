...
$(document).on("inview", ".rate_bar_wrap", function(event, visible) {
  ...
  // You can add custom Javascript code right here.
    ...
    (function( jQuery ){
  var $module = jQuery('#m-1705414202375').children('.module');
  ...
  if(mode == 'dev') {
    var moduleId = "1705414202375";
    var moduleIdSlug = moduleId.toString().replace(/-/g, '');
    if (moduleIdSlug == "1705414202375") {
      window.getTab1705414202375 = function() {
    ...
    (function( jQuery ){
  var $module = jQuery('#m-1705414194891').children('.module');
  $module.gfV1Popup();

  var mode = jQuery('.gryffeditor').hasClass('editing') ? 'dev' : 'production';
  if(mode == 'dev') {
    var moduleId = "1705414194891";
    var moduleIdSlug = moduleId.toString().replace(/-/g, '');
    if (moduleIdSlug == "1705414194891") {
      window.getPopup1705414194891 = function() {
