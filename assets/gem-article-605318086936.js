...
(function( jQuery ){
  // var $module = jQuery('#m-1687198650465').children('.module');
  // You can add custom Javascript code right here.
})( window.GemQuery || jQuery );
  ...
  // You can add custom Javascript code right here.
    ...
    (function( jQuery ){
  var $module = jQuery('#m-1701388716638').children('.module');
  ...
  if(mode == 'dev') {
    var moduleId = "1701388716638";
    var moduleIdSlug = moduleId.toString().replace(/-/g, '');
    if (moduleIdSlug == "1701388716638") {
      window.getTab1701388716638 = function() {
    ...
    (function( jQuery ){
  var $module = jQuery('#m-1701388735290').children('.module');
  $module.gfV1Popup();

  var mode = jQuery('.gryffeditor').hasClass('editing') ? 'dev' : 'production';
  if(mode == 'dev') {
    var moduleId = "1701388735290";
    var moduleIdSlug = moduleId.toString().replace(/-/g, '');
    if (moduleIdSlug == "1701388735290") {
      window.getPopup1701388735290 = function() {
