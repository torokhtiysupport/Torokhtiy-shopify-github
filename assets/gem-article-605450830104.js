...
(function( jQuery ){
  ...
  // You can add custom Javascript code right here.
    ...
    (function( jQuery ){
  var $module = jQuery('#m-1701425988634').children('.module');
  ...
  if(mode == 'dev') {
    var moduleId = "1701425988634";
    var moduleIdSlug = moduleId.toString().replace(/-/g, '');
    if (moduleIdSlug == "1701425988634") {
      window.getTab1701425988634 = function() {
    ...
    (function( jQuery ){
  var $module = jQuery('#m-1701426034576').children('.module');
  $module.gfV1Popup();

  var mode = jQuery('.gryffeditor').hasClass('editing') ? 'dev' : 'production';
  if(mode == 'dev') {
    var moduleId = "1701426034576";
    var moduleIdSlug = moduleId.toString().replace(/-/g, '');
    if (moduleIdSlug == "1701426034576") {
      window.getPopup1701426034576 = function() {
