    ...
    (function( jQuery ){
  // var $module = jQuery('#m-1693424732278').children('.module');
...
(function( jQuery ){
  // var $module = jQuery('#m-1660217203762').children('.module');
  // You can add custom Javascript code right here.
})( window.GemQuery || jQuery );
    ...
    (function( jQuery ){
  // var $module = jQuery('#m-1674066922037').children('.module');
  // You can add custom Javascript code right here.
})( window.GemQuery || jQuery );
    ...
    (function( jQuery ){
  // var $module = jQuery('#m-1674567953522').children('.module');
  // You can add custom Javascript code right here.
})( window.GemQuery || jQuery );
  
(function( jQuery ){
  // var $module = jQuery('#m-1674066922064').children('.module');
  // You can add custom Javascript code right here.
})( window.GemQuery || jQuery );
    ...
    (function( jQuery ){
  var $module = jQuery('#m-1701131661437').children('.module');
  ...
  if(mode == 'dev') {
    var moduleId = "1701131661437";
    var moduleIdSlug = moduleId.toString().replace(/-/g, '');
    if (moduleIdSlug == "1701131661437") {
      window.getTab1701131661437 = function() {
    ...
    (function( jQuery ){
  var $module = jQuery('#m-1701131760476').children('.module');
  $module.gfV1Popup();

  var mode = jQuery('.gryffeditor').hasClass('editing') ? 'dev' : 'production';
  if(mode == 'dev') {
    var moduleId = "1701131760476";
    var moduleIdSlug = moduleId.toString().replace(/-/g, '');
    if (moduleIdSlug == "1701131760476") {
      window.getPopup1701131760476 = function() {
