...
$(document).on("inview", ".rate_bar_wrap", function(event, visible) {
    ...
    (function( jQuery ){
  // var $module = jQuery('#m-1693424102756').children('.module');
...
$(document).on("inview", ".rate_bar_wrap", function(event, visible) {
  ...
  // You can add custom Javascript code right here.
    ...
    (function( jQuery ){
  var $module = jQuery('#m-1701368209783').children('.module');
  ...
  if(mode == 'dev') {
    var moduleId = "1701368209783";
    var moduleIdSlug = moduleId.toString().replace(/-/g, '');
    if (moduleIdSlug == "1701368209783") {
      window.getTab1701368209783 = function() {
    ...
    (function( jQuery ){
  var $module = jQuery('#m-1701368239657').children('.module');
  $module.gfV1Popup();

  var mode = jQuery('.gryffeditor').hasClass('editing') ? 'dev' : 'production';
  if(mode == 'dev') {
    var moduleId = "1701368239657";
    var moduleIdSlug = moduleId.toString().replace(/-/g, '');
    if (moduleIdSlug == "1701368239657") {
      window.getPopup1701368239657 = function() {
