...
$(document).on("inview", ".rate_bar_wrap", function(event, visible) {
  ...
  // You can add custom Javascript code right here.
    ...
    (function( jQuery ){
  // var $module = jQuery('#m-1673731019222').children('.module');
  // You can add custom Javascript code right here.
})( window.GemQuery || jQuery );
(function( jQuery ){
  // var $module = jQuery('#m-1673731019233').children('.module');
  // You can add custom Javascript code right here.
})( window.GemQuery || jQuery );
    
    (function( jQuery ){
  var $module = jQuery('#m-1701246995582').children('.module');
  ...
  if(mode == 'dev') {
    var moduleId = "1701246995582";
    var moduleIdSlug = moduleId.toString().replace(/-/g, '');
    if (moduleIdSlug == "1701246995582") {
      window.getTab1701246995582 = function() {
    ...
    (function( jQuery ){
  // var $module = jQuery('#m-1673731019186').children('.module');
  // You can add custom Javascript code right here.
})( window.GemQuery || jQuery );
    ...
    (function( jQuery ){
  var $module = jQuery('#m-1700135490008').children('.module');
  $module.gfV1Popup();

  var mode = jQuery('.gryffeditor').hasClass('editing') ? 'dev' : 'production';
  if(mode == 'dev') {
    var moduleId = "1700135490008";
    var moduleIdSlug = moduleId.toString().replace(/-/g, '');
    if (moduleIdSlug == "1700135490008") {
      window.getPopup1700135490008 = function() {
