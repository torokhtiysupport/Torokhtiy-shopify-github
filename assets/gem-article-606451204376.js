...
(function( jQuery ){
  ...
  // You can add custom Javascript code right here.
    ...
    (function( jQuery ){
  // var $module = jQuery('#m-1696948575932').children('.module');
  // You can add custom Javascript code right here.
})( window.GemQuery || jQuery );
  ...
  // You can add custom Javascript code right here.
    ...
    (function( jQuery ){
  // var $module = jQuery('#m-1696976139473').children('.module');
  // You can add custom Javascript code right here.
})( window.GemQuery || jQuery );
    ...
    (function( jQuery ){
  var $module = jQuery('#m-1696976771883').children('.module');
  ...
  if(mode == 'dev') {
    var moduleId = "1696976771883";
    var moduleIdSlug = moduleId.toString().replace(/-/g, '');
    if (moduleIdSlug == "1696976771883") {
      window.getTab1696976771883 = function() {
    ...
    (function( jQuery ){
  // var $module = jQuery('#m-1699364684796').children('.module');
  // You can add custom Javascript code right here.
})( window.GemQuery || jQuery );
