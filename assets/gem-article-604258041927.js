...
(function( jQuery ){
  // var $module = jQuery('#m-1664287310184').children('.module');
  // You can add custom Javascript code right here.
})( window.GemQuery || jQuery );
...
$(document).on("inview", ".rate_bar_wrap", function(event, visible) {
    ...
    (function( jQuery ){
  // var $module = jQuery('#m-1668020571686').children('.module');
  // You can add custom Javascript code right here.
})( window.GemQuery || jQuery );
  
    (function( jQuery ){
  // var $module = jQuery('#m-1700137824408').children('.module');
  // You can add custom Javascript code right here.
})( window.GemQuery || jQuery );
    ...
    (function( jQuery ){
  var $module = jQuery('#m-1700137364432').children('.module');
  ...
  if(mode == 'dev') {
    var moduleId = "1700137364432";
    var moduleIdSlug = moduleId.toString().replace(/-/g, '');
    if (moduleIdSlug == "1700137364432") {
      window.getTab1700137364432 = function() {
    ...
    (function( jQuery ){
  // var $module = jQuery('#m-1673713197741').children('.module');
  // You can add custom Javascript code right here.
})( window.GemQuery || jQuery );
  
    (function( jQuery ){
  var $module = jQuery('#m-1700137411225').children('.module');
  $module.gfV1Popup();

  var mode = jQuery('.gryffeditor').hasClass('editing') ? 'dev' : 'production';
  if(mode == 'dev') {
    var moduleId = "1700137411225";
    var moduleIdSlug = moduleId.toString().replace(/-/g, '');
    if (moduleIdSlug == "1700137411225") {
      window.getPopup1700137411225 = function() {
