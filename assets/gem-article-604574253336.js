...
$(document).on("inview", ".rate_bar_wrap", function(event, visible) {
    ...
    (function( jQuery ){
  // var $module = jQuery('#m-1674653590685').children('.module');
  // You can add custom Javascript code right here.
})( window.GemQuery || jQuery );
  ...
  // You can add custom Javascript code right here.
    ...
    (function( jQuery ){
  var $module = jQuery('#m-1700033553984').children('.module');
  ...
  if(mode == 'dev') {
    var moduleId = "1700033553984";
    var moduleIdSlug = moduleId.toString().replace(/-/g, '');
    if (moduleIdSlug == "1700033553984") {
      window.getTab1700033553984 = function() {
    ...
    (function( jQuery ){
  // var $module = jQuery('#m-1673535715862').children('.module');
  // You can add custom Javascript code right here.
})( window.GemQuery || jQuery );
  
    
    (function( jQuery ){
  var $module = jQuery('#m-1700034183221').children('.module');
  $module.gfV1Popup();

  var mode = jQuery('.gryffeditor').hasClass('editing') ? 'dev' : 'production';
  if(mode == 'dev') {
    var moduleId = "1700034183221";
    var moduleIdSlug = moduleId.toString().replace(/-/g, '');
    if (moduleIdSlug == "1700034183221") {
      window.getPopup1700034183221 = function() {
