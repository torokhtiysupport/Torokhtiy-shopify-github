...
(function( jQuery ){
  ...
  // You can add custom Javascript code right here.
    ...
    (function( jQuery ){
  var $module = jQuery('#m-1701431236143').children('.module');
  ...
  if(mode == 'dev') {
    var moduleId = "1701431236143";
    var moduleIdSlug = moduleId.toString().replace(/-/g, '');
    if (moduleIdSlug == "1701431236143") {
      window.getTab1701431236143 = function() {
    ...
    (function( jQuery ){
  var $module = jQuery('#m-1701431279684').children('.module');
  $module.gfV1Popup();

  var mode = jQuery('.gryffeditor').hasClass('editing') ? 'dev' : 'production';
  if(mode == 'dev') {
    var moduleId = "1701431279684";
    var moduleIdSlug = moduleId.toString().replace(/-/g, '');
    if (moduleIdSlug == "1701431279684") {
      window.getPopup1701431279684 = function() {
