...
(function( jQuery ){
  // var $module = jQuery('#m-1687199059458').children('.module');
  // You can add custom Javascript code right here.
})( window.GemQuery || jQuery );
    ...
    (function( jQuery ){
  var $module = jQuery('#m-1701391502987').children('.module');
  ...
  if(mode == 'dev') {
    var moduleId = "1701391502987";
    var moduleIdSlug = moduleId.toString().replace(/-/g, '');
    if (moduleIdSlug == "1701391502987") {
      window.getTab1701391502987 = function() {
    ...
    (function( jQuery ){
  var $module = jQuery('#m-1701391522157').children('.module');
  $module.gfV1Popup();

  var mode = jQuery('.gryffeditor').hasClass('editing') ? 'dev' : 'production';
  if(mode == 'dev') {
    var moduleId = "1701391522157";
    var moduleIdSlug = moduleId.toString().replace(/-/g, '');
    if (moduleIdSlug == "1701391522157") {
      window.getPopup1701391522157 = function() {
