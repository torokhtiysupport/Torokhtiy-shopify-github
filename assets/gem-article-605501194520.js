...
$(document).on("inview", ".rate_bar_wrap", function(event, visible) {
  ...
  // You can add custom Javascript code right here.
    ...
    (function( jQuery ){
  var $module = jQuery('#m-1701211349598').children('.module');
  ...
  if(mode == 'dev') {
    var moduleId = "1701211349598";
    var moduleIdSlug = moduleId.toString().replace(/-/g, '');
    if (moduleIdSlug == "1701211349598") {
      window.getTab1701211349598 = function() {
    ...
    (function( jQuery ){
  var $module = jQuery('#m-1701211456653').children('.module');
  $module.gfV1Popup();

  var mode = jQuery('.gryffeditor').hasClass('editing') ? 'dev' : 'production';
  if(mode == 'dev') {
    var moduleId = "1701211456653";
    var moduleIdSlug = moduleId.toString().replace(/-/g, '');
    if (moduleIdSlug == "1701211456653") {
      window.getPopup1701211456653 = function() {
