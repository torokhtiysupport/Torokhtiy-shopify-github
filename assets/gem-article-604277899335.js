    ...
    (function( jQuery ){
  // var $module = jQuery('#m-1673715086639').children('.module');
  // You can add custom Javascript code right here.
})( window.GemQuery || jQuery );
  
    (function( jQuery ){
  // var $module = jQuery('#m-1668072281967').children('.module');
  // You can add custom Javascript code right here.
})( window.GemQuery || jQuery );
...
(function( jQuery ){
  ...
  // You can add custom Javascript code right here.
    ...
    (function( jQuery ){
  var $module = jQuery('#m-1701133014825').children('.module');
  ...
  if(mode == 'dev') {
    var moduleId = "1701133014825";
    var moduleIdSlug = moduleId.toString().replace(/-/g, '');
    if (moduleIdSlug == "1701133014825") {
      window.getTab1701133014825 = function() {
    ...
    (function( jQuery ){
  var $module = jQuery('#m-1701133072972').children('.module');
  $module.gfV1Popup();

  var mode = jQuery('.gryffeditor').hasClass('editing') ? 'dev' : 'production';
  if(mode == 'dev') {
    var moduleId = "1701133072972";
    var moduleIdSlug = moduleId.toString().replace(/-/g, '');
    if (moduleIdSlug == "1701133072972") {
      window.getPopup1701133072972 = function() {
