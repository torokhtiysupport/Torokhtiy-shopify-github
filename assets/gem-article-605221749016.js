...
$(document).on("inview", ".rate_bar_wrap", function(event, visible) {
  ...
  // You can add custom Javascript code right here.
    ...
    (function( jQuery ){
  var $module = jQuery('#m-1701300983226').children('.module');
  ...
  if(mode == 'dev') {
    var moduleId = "1701300983226";
    var moduleIdSlug = moduleId.toString().replace(/-/g, '');
    if (moduleIdSlug == "1701300983226") {
      window.getTab1701300983226 = function() {
    ...
    (function( jQuery ){
  var $module = jQuery('#m-1701301030551').children('.module');
  $module.gfV1Popup();

  var mode = jQuery('.gryffeditor').hasClass('editing') ? 'dev' : 'production';
  if(mode == 'dev') {
    var moduleId = "1701301030551";
    var moduleIdSlug = moduleId.toString().replace(/-/g, '');
    if (moduleIdSlug == "1701301030551") {
      window.getPopup1701301030551 = function() {
