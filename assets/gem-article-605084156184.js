...
(function( jQuery ){
  ...
  // You can add custom Javascript code right here.
    ...
    (function( jQuery ){
  var $module = jQuery('#m-1701298292337').children('.module');
  ...
  if(mode == 'dev') {
    var moduleId = "1701298292337";
    var moduleIdSlug = moduleId.toString().replace(/-/g, '');
    if (moduleIdSlug == "1701298292337") {
      window.getTab1701298292337 = function() {
    ...
    (function( jQuery ){
  var $module = jQuery('#m-1701298301014').children('.module');
  $module.gfV1Popup();

  var mode = jQuery('.gryffeditor').hasClass('editing') ? 'dev' : 'production';
  if(mode == 'dev') {
    var moduleId = "1701298301014";
    var moduleIdSlug = moduleId.toString().replace(/-/g, '');
    if (moduleIdSlug == "1701298301014") {
      window.getPopup1701298301014 = function() {
