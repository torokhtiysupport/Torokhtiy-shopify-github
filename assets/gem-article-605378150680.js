    ...
    (function( jQuery ){
  // var $module = jQuery('#m-1685217275500').children('.module');
...
$(document).on("inview", ".rate_bar_wrap", function(event, visible) {
    ...
    (function( jQuery ){
  // var $module = jQuery('#m-1683536636245').children('.module');
  // You can add custom Javascript code right here.
})( window.GemQuery || jQuery );
    (function( jQuery ){
  ...
  // You can add custom Javascript code right here.
    ...
    (function( jQuery ){
  var $module = jQuery('#m-1701391140483').children('.module');
  ...
  if(mode == 'dev') {
    var moduleId = "1701391140483";
    var moduleIdSlug = moduleId.toString().replace(/-/g, '');
    if (moduleIdSlug == "1701391140483") {
      window.getTab1701391140483 = function() {
    ...
    (function( jQuery ){
  var $module = jQuery('#m-1701391182345').children('.module');
  $module.gfV1Popup();

  var mode = jQuery('.gryffeditor').hasClass('editing') ? 'dev' : 'production';
  if(mode == 'dev') {
    var moduleId = "1701391182345";
    var moduleIdSlug = moduleId.toString().replace(/-/g, '');
    if (moduleIdSlug == "1701391182345") {
      window.getPopup1701391182345 = function() {
