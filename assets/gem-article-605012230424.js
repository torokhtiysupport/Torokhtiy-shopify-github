...
$(document).on("inview", ".rate_bar_wrap", function(event, visible) {
  ...
  // You can add custom Javascript code right here.
    ...
    (function( jQuery ){
  var $module = jQuery('#m-1701296944910').children('.module');
  ...
  if(mode == 'dev') {
    var moduleId = "1701296944910";
    var moduleIdSlug = moduleId.toString().replace(/-/g, '');
    if (moduleIdSlug == "1701296944910") {
      window.getTab1701296944910 = function() {
    ...
    (function( jQuery ){
  var $module = jQuery('#m-1701296961228').children('.module');
  $module.gfV1Popup();

  var mode = jQuery('.gryffeditor').hasClass('editing') ? 'dev' : 'production';
  if(mode == 'dev') {
    var moduleId = "1701296961228";
    var moduleIdSlug = moduleId.toString().replace(/-/g, '');
    if (moduleIdSlug == "1701296961228") {
      window.getPopup1701296961228 = function() {
