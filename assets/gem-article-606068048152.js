...
(function( jQuery ){
  // var $module = jQuery('#m-1699573491222').children('.module');
  // You can add custom Javascript code right here.
})( window.GemQuery || jQuery );
...
(function( jQuery ){
  // var $module = jQuery('#m-1699573758830').children('.module');
  // You can add custom Javascript code right here.
})( window.GemQuery || jQuery );
  ...
  // You can add custom Javascript code right here.
    ...
    (function( jQuery ){
  var $module = jQuery('#m-1699579128283').children('.module');
  ...
  if(mode == 'dev') {
    var moduleId = "1699579128283";
    var moduleIdSlug = moduleId.toString().replace(/-/g, '');
    if (moduleIdSlug == "1699579128283") {
      window.getTab1699579128283 = function() {
    ...
    (function( jQuery ){
  var $module = jQuery('#m-1699637655758').children('.module');
  $module.gfV1Popup();

  var mode = jQuery('.gryffeditor').hasClass('editing') ? 'dev' : 'production';
  if(mode == 'dev') {
    var moduleId = "1699637655758";
    var moduleIdSlug = moduleId.toString().replace(/-/g, '');
    if (moduleIdSlug == "1699637655758") {
      window.getPopup1699637655758 = function() {
