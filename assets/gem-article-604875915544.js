...
$(document).on("inview", ".rate_bar_wrap", function(event, visible) {
  ...
  // You can add custom Javascript code right here.
    ...
    (function( jQuery ){
  var $module = jQuery('#m-1705405262390').children('.module');
  ...
  if(mode == 'dev') {
    var moduleId = "1705405262390";
    var moduleIdSlug = moduleId.toString().replace(/-/g, '');
    if (moduleIdSlug == "1705405262390") {
      window.getTab1705405262390 = function() {
    ...
    (function( jQuery ){
  var $module = jQuery('#m-1705404855761').children('.module');
  $module.gfV1Popup();

  var mode = jQuery('.gryffeditor').hasClass('editing') ? 'dev' : 'production';
  if(mode == 'dev') {
    var moduleId = "1705404855761";
    var moduleIdSlug = moduleId.toString().replace(/-/g, '');
    if (moduleIdSlug == "1705404855761") {
      window.getPopup1705404855761 = function() {
