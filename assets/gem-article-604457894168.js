...
(function( jQuery ){
  ...
  // You can add custom Javascript code right here.
    ...
    (function( jQuery ){
  // var $module = jQuery('#m-1671369279693').children('.module');
  // You can add custom Javascript code right here.
})( window.GemQuery || jQuery );
    ...
    (function( jQuery ){
  var $module = jQuery('#m-1700482146131').children('.module');
  ...
  if(mode == 'dev') {
    var moduleId = "1700482146131";
    var moduleIdSlug = moduleId.toString().replace(/-/g, '');
    if (moduleIdSlug == "1700482146131") {
      window.getTab1700482146131 = function() {
    ...
    (function( jQuery ){
  // var $module = jQuery('#m-1673719852532').children('.module');
  // You can add custom Javascript code right here.
})( window.GemQuery || jQuery );
  
    (function( jQuery ){
  var $module = jQuery('#m-1700482182863').children('.module');
  $module.gfV1Popup();

  var mode = jQuery('.gryffeditor').hasClass('editing') ? 'dev' : 'production';
  if(mode == 'dev') {
    var moduleId = "1700482182863";
    var moduleIdSlug = moduleId.toString().replace(/-/g, '');
    if (moduleIdSlug == "1700482182863") {
      window.getPopup1700482182863 = function() {
