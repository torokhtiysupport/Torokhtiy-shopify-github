    ...
    (function( jQuery ){
  // var $module = jQuery('#m-1671368480906').children('.module');
  ...
  // You can add custom Javascript code right here.
    ...
    (function( jQuery ){
  // var $module = jQuery('#m-1673719688157').children('.module');
  // You can add custom Javascript code right here.
})( window.GemQuery || jQuery );
  ...
  // You can add custom Javascript code right here.
    ...
    (function( jQuery ){
  var $module = jQuery('#m-1700555712663').children('.module');
  ...
  if(mode == 'dev') {
    var moduleId = "1700555712663";
    var moduleIdSlug = moduleId.toString().replace(/-/g, '');
    if (moduleIdSlug == "1700555712663") {
      window.getTab1700555712663 = function() {
    ...
    (function( jQuery ){
  var $module = jQuery('#m-1700555749350').children('.module');
  $module.gfV1Popup();

  var mode = jQuery('.gryffeditor').hasClass('editing') ? 'dev' : 'production';
  if(mode == 'dev') {
    var moduleId = "1700555749350";
    var moduleIdSlug = moduleId.toString().replace(/-/g, '');
    if (moduleIdSlug == "1700555749350") {
      window.getPopup1700555749350 = function() {
