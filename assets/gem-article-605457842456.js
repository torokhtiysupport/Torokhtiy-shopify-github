...
$(document).on("inview", ".rate_bar_wrap", function(event, visible) {
  ...
  // You can add custom Javascript code right here.
    ...
    (function( jQuery ){
  var $module = jQuery('#m-1701424708263').children('.module');
  ...
  if(mode == 'dev') {
    var moduleId = "1701424708263";
    var moduleIdSlug = moduleId.toString().replace(/-/g, '');
    if (moduleIdSlug == "1701424708263") {
      window.getTab1701424708263 = function() {
    ...
    (function( jQuery ){
  var $module = jQuery('#m-1701424748233').children('.module');
  $module.gfV1Popup();

  var mode = jQuery('.gryffeditor').hasClass('editing') ? 'dev' : 'production';
  if(mode == 'dev') {
    var moduleId = "1701424748233";
    var moduleIdSlug = moduleId.toString().replace(/-/g, '');
    if (moduleIdSlug == "1701424748233") {
      window.getPopup1701424748233 = function() {
