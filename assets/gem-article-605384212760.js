...
(function( jQuery ){
  ...
  // You can add custom Javascript code right here.
    ...
    (function( jQuery ){
  var $module = jQuery('#m-1701394716966').children('.module');
  ...
  if(mode == 'dev') {
    var moduleId = "1701394716966";
    var moduleIdSlug = moduleId.toString().replace(/-/g, '');
    if (moduleIdSlug == "1701394716966") {
      window.getTab1701394716966 = function() {
    ...
    (function( jQuery ){
  var $module = jQuery('#m-1701394734452').children('.module');
  $module.gfV1Popup();

  var mode = jQuery('.gryffeditor').hasClass('editing') ? 'dev' : 'production';
  if(mode == 'dev') {
    var moduleId = "1701394734452";
    var moduleIdSlug = moduleId.toString().replace(/-/g, '');
    if (moduleIdSlug == "1701394734452") {
      window.getPopup1701394734452 = function() {
