...
(function( jQuery ){
  ...
  // You can add custom Javascript code right here.
    ...
    (function( jQuery ){
  // var $module = jQuery('#m-1673714084127').children('.module');
  // You can add custom Javascript code right here.
})( window.GemQuery || jQuery );
  
    (function( jQuery ){
  // var $module = jQuery('#m-1668029139498').children('.module');
  // You can add custom Javascript code right here.
})( window.GemQuery || jQuery );
  
(function( jQuery ){
  // var $module = jQuery('#m-1663786285464').children('.module');
  // You can add custom Javascript code right here.
})( window.GemQuery || jQuery );
    ...
    (function( jQuery ){
  var $module = jQuery('#m-1700487104541').children('.module');
  ...
  if(mode == 'dev') {
    var moduleId = "1700487104541";
    var moduleIdSlug = moduleId.toString().replace(/-/g, '');
    if (moduleIdSlug == "1700487104541") {
      window.getTab1700487104541 = function() {
    ...
    (function( jQuery ){
  var $module = jQuery('#m-1700487165411').children('.module');
  $module.gfV1Popup();

  var mode = jQuery('.gryffeditor').hasClass('editing') ? 'dev' : 'production';
  if(mode == 'dev') {
    var moduleId = "1700487165411";
    var moduleIdSlug = moduleId.toString().replace(/-/g, '');
    if (moduleIdSlug == "1700487165411") {
      window.getPopup1700487165411 = function() {
