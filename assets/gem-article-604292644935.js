...
(function( jQuery ){
  // var $module = jQuery('#m-1667728493230').children('.module');
  // You can add custom Javascript code right here.
})( window.GemQuery || jQuery );
...
(function( jQuery ){
  // var $module = jQuery('#m-1665262908186').children('.module');
  // You can add custom Javascript code right here.
})( window.GemQuery || jQuery );
    ...
    (function( jQuery ){
  // var $module = jQuery('#m-1673649930104').children('.module');
  // You can add custom Javascript code right here.
})( window.GemQuery || jQuery );
  
    (function( jQuery ){
  var $module = jQuery('#m-1700465783827').children('.module');
  ...
  if(mode == 'dev') {
    var moduleId = "1700465783827";
    var moduleIdSlug = moduleId.toString().replace(/-/g, '');
    if (moduleIdSlug == "1700465783827") {
      window.getTab1700465783827 = function() {
    ...
    (function( jQuery ){
  var $module = jQuery('#m-1700465866350').children('.module');
  $module.gfV1Popup();

  var mode = jQuery('.gryffeditor').hasClass('editing') ? 'dev' : 'production';
  if(mode == 'dev') {
    var moduleId = "1700465866350";
    var moduleIdSlug = moduleId.toString().replace(/-/g, '');
    if (moduleIdSlug == "1700465866350") {
      window.getPopup1700465866350 = function() {
