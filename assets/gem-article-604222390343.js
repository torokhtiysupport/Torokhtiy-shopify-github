    ...
    (function( jQuery ){
  // var $module = jQuery('#m-1673713924289').children('.module');
  // You can add custom Javascript code right here.
})( window.GemQuery || jQuery );
  
(function( jQuery ){
  // var $module = jQuery('#m-1663764167600').children('.module');
  // You can add custom Javascript code right here.
})( window.GemQuery || jQuery );
...
(function( jQuery ){
  ...
  // You can add custom Javascript code right here.
    ...
    (function( jQuery ){
  var $module = jQuery('#m-1700569176301').children('.module');
  ...
  if(mode == 'dev') {
    var moduleId = "1700569176301";
    var moduleIdSlug = moduleId.toString().replace(/-/g, '');
    if (moduleIdSlug == "1700569176301") {
      window.getTab1700569176301 = function() {
    ...
    (function( jQuery ){
  var $module = jQuery('#m-1700569209754').children('.module');
  $module.gfV1Popup();

  var mode = jQuery('.gryffeditor').hasClass('editing') ? 'dev' : 'production';
  if(mode == 'dev') {
    var moduleId = "1700569209754";
    var moduleIdSlug = moduleId.toString().replace(/-/g, '');
    if (moduleIdSlug == "1700569209754") {
      window.getPopup1700569209754 = function() {
