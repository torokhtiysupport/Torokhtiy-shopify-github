...
$(document).on("inview", ".rate_bar_wrap", function(event, visible) {
  ...
  // You can add custom Javascript code right here.
    ...
    (function( jQuery ){
  var $module = jQuery('#m-1701295704009').children('.module');
  ...
  if(mode == 'dev') {
    var moduleId = "1701295704009";
    var moduleIdSlug = moduleId.toString().replace(/-/g, '');
    if (moduleIdSlug == "1701295704009") {
      window.getTab1701295704009 = function() {
    ...
    (function( jQuery ){
  var $module = jQuery('#m-1701295715293').children('.module');
  $module.gfV1Popup();

  var mode = jQuery('.gryffeditor').hasClass('editing') ? 'dev' : 'production';
  if(mode == 'dev') {
    var moduleId = "1701295715293";
    var moduleIdSlug = moduleId.toString().replace(/-/g, '');
    if (moduleIdSlug == "1701295715293") {
      window.getPopup1701295715293 = function() {
