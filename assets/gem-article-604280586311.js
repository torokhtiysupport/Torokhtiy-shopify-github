    ...
    (function( jQuery ){
  // var $module = jQuery('#m-1668072412482').children('.module');
...
(function( jQuery ){
  ...
  // You can add custom Javascript code right here.
    ...
    (function( jQuery ){
  // var $module = jQuery('#m-1673715166888').children('.module');
  // You can add custom Javascript code right here.
})( window.GemQuery || jQuery );
...
(function( jQuery ){
  ...
  // You can add custom Javascript code right here.
    ...
    (function( jQuery ){
  var $module = jQuery('#m-1700569532201').children('.module');
  ...
  if(mode == 'dev') {
    var moduleId = "1700569532201";
    var moduleIdSlug = moduleId.toString().replace(/-/g, '');
    if (moduleIdSlug == "1700569532201") {
      window.getTab1700569532201 = function() {
    ...
    (function( jQuery ){
  var $module = jQuery('#m-1700569568191').children('.module');
  $module.gfV1Popup();

  var mode = jQuery('.gryffeditor').hasClass('editing') ? 'dev' : 'production';
  if(mode == 'dev') {
    var moduleId = "1700569568191";
    var moduleIdSlug = moduleId.toString().replace(/-/g, '');
    if (moduleIdSlug == "1700569568191") {
      window.getPopup1700569568191 = function() {
