...
(function( jQuery ){
  // var $module = jQuery('#m-1663746234635').children('.module');
  // You can add custom Javascript code right here.
})( window.GemQuery || jQuery );
    
(function( jQuery ){
  // var $module = jQuery('#m-1662556377453').children('.module');
  // You can add custom Javascript code right here.
})( window.GemQuery || jQuery );
...
$(document).on("inview", ".rate_bar_wrap", function(event, visible) {
    ...
    (function( jQuery ){
  // var $module = jQuery('#m-1673714900781').children('.module');
  // You can add custom Javascript code right here.
})( window.GemQuery || jQuery );
    ...
    (function( jQuery ){
  var $module = jQuery('#m-1700552239343').children('.module');
  ...
  if(mode == 'dev') {
    var moduleId = "1700552239343";
    var moduleIdSlug = moduleId.toString().replace(/-/g, '');
    if (moduleIdSlug == "1700552239343") {
      window.getTab1700552239343 = function() {
    ...
    (function( jQuery ){
  var $module = jQuery('#m-1700552285546').children('.module');
  $module.gfV1Popup();

  var mode = jQuery('.gryffeditor').hasClass('editing') ? 'dev' : 'production';
  if(mode == 'dev') {
    var moduleId = "1700552285546";
    var moduleIdSlug = moduleId.toString().replace(/-/g, '');
    if (moduleIdSlug == "1700552285546") {
      window.getPopup1700552285546 = function() {
