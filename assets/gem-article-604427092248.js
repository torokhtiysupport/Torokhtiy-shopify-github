    ...
    (function( jQuery ){
  // var $module = jQuery('#m-1674579960830').children('.module');
  ...
  // You can add custom Javascript code right here.
    ...
    (function( jQuery ){
  var $module = jQuery('#m-1700470317067').children('.module');
  ...
  if(mode == 'dev') {
    var moduleId = "1700470317067";
    var moduleIdSlug = moduleId.toString().replace(/-/g, '');
    if (moduleIdSlug == "1700470317067") {
      window.getTab1700470317067 = function() {
    ...
    (function( jQuery ){
  // var $module = jQuery('#m-1673719054397').children('.module');
  // You can add custom Javascript code right here.
})( window.GemQuery || jQuery );
  ...
  // You can add custom Javascript code right here.
    ...
    (function( jQuery ){
  var $module = jQuery('#m-1700470356793').children('.module');
  $module.gfV1Popup();

  var mode = jQuery('.gryffeditor').hasClass('editing') ? 'dev' : 'production';
  if(mode == 'dev') {
    var moduleId = "1700470356793";
    var moduleIdSlug = moduleId.toString().replace(/-/g, '');
    if (moduleIdSlug == "1700470356793") {
      window.getPopup1700470356793 = function() {
