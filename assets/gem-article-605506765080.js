...
$(document).on("inview", ".rate_bar_wrap", function(event, visible) {
  ...
  // You can add custom Javascript code right here.
    ...
    (function( jQuery ){
  var $module = jQuery('#m-1701203146810').children('.module');
  ...
  if(mode == 'dev') {
    var moduleId = "1701203146810";
    var moduleIdSlug = moduleId.toString().replace(/-/g, '');
    if (moduleIdSlug == "1701203146810") {
      window.getTab1701203146810 = function() {
    ...
    (function( jQuery ){
  var $module = jQuery('#m-1701203262649').children('.module');
  $module.gfV1Popup();

  var mode = jQuery('.gryffeditor').hasClass('editing') ? 'dev' : 'production';
  if(mode == 'dev') {
    var moduleId = "1701203262649";
    var moduleIdSlug = moduleId.toString().replace(/-/g, '');
    if (moduleIdSlug == "1701203262649") {
      window.getPopup1701203262649 = function() {
