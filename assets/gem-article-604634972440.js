...
(function( jQuery ){
  ...
  // You can add custom Javascript code right here.
    ...
    (function( jQuery ){
  // var $module = jQuery('#m-1674663248309').children('.module');
  // You can add custom Javascript code right here.
})( window.GemQuery || jQuery );
...
(function( jQuery ){
  ...
  // You can add custom Javascript code right here.
    ...
    (function( jQuery ){
  var $module = jQuery('#m-1701129828895').children('.module');
  ...
  if(mode == 'dev') {
    var moduleId = "1701129828895";
    var moduleIdSlug = moduleId.toString().replace(/-/g, '');
    if (moduleIdSlug == "1701129828895") {
      window.getTab1701129828895 = function() {
    ...
    (function( jQuery ){
  var $module = jQuery('#m-1701129900288').children('.module');
  $module.gfV1Popup();

  var mode = jQuery('.gryffeditor').hasClass('editing') ? 'dev' : 'production';
  if(mode == 'dev') {
    var moduleId = "1701129900288";
    var moduleIdSlug = moduleId.toString().replace(/-/g, '');
    if (moduleIdSlug == "1701129900288") {
      window.getPopup1701129900288 = function() {
