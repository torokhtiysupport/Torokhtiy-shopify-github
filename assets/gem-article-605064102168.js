...
(function( jQuery ){
  ...
  // You can add custom Javascript code right here.
    ...
    (function( jQuery ){
  var $module = jQuery('#m-1700038273502').children('.module');
  ...
  if(mode == 'dev') {
    var moduleId = "1700038273502";
    var moduleIdSlug = moduleId.toString().replace(/-/g, '');
    if (moduleIdSlug == "1700038273502") {
      window.getTab1700038273502 = function() {
    ...
    (function( jQuery ){
  var $module = jQuery('#m-1700038337007').children('.module');
  $module.gfV1Popup();

  var mode = jQuery('.gryffeditor').hasClass('editing') ? 'dev' : 'production';
  if(mode == 'dev') {
    var moduleId = "1700038337007";
    var moduleIdSlug = moduleId.toString().replace(/-/g, '');
    if (moduleIdSlug == "1700038337007") {
      window.getPopup1700038337007 = function() {
