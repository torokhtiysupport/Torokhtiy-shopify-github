  ...
  // You can add custom Javascript code right here.
    ...
    (function( jQuery ){
  // var $module = jQuery('#m-1684791169563').children('.module');
  // You can add custom Javascript code right here.
})( window.GemQuery || jQuery );
    ...
    (function( jQuery ){
  var $module = jQuery('#m-1701299810254').children('.module');
  ...
  if(mode == 'dev') {
    var moduleId = "1701299810254";
    var moduleIdSlug = moduleId.toString().replace(/-/g, '');
    if (moduleIdSlug == "1701299810254") {
      window.getTab1701299810254 = function() {
    ...
    (function( jQuery ){
  var $module = jQuery('#m-1701299834823').children('.module');
  $module.gfV1Popup();

  var mode = jQuery('.gryffeditor').hasClass('editing') ? 'dev' : 'production';
  if(mode == 'dev') {
    var moduleId = "1701299834823";
    var moduleIdSlug = moduleId.toString().replace(/-/g, '');
    if (moduleIdSlug == "1701299834823") {
      window.getPopup1701299834823 = function() {
