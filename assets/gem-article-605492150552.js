...
(function( jQuery ){
  // var $module = jQuery('#m-1686788790060').children('.module');
  // You can add custom Javascript code right here.
})( window.GemQuery || jQuery );
    
    (function( jQuery ){
  var $module = jQuery('#m-1701419005776').children('.module');
  ...
  if(mode == 'dev') {
    var moduleId = "1701419005776";
    var moduleIdSlug = moduleId.toString().replace(/-/g, '');
    if (moduleIdSlug == "1701419005776") {
      window.getTab1701419005776 = function() {
    ...
    (function( jQuery ){
  var $module = jQuery('#m-1701419059242').children('.module');
  $module.gfV1Popup();

  var mode = jQuery('.gryffeditor').hasClass('editing') ? 'dev' : 'production';
  if(mode == 'dev') {
    var moduleId = "1701419059242";
    var moduleIdSlug = moduleId.toString().replace(/-/g, '');
    if (moduleIdSlug == "1701419059242") {
      window.getPopup1701419059242 = function() {
