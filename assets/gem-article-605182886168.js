...
(function( jQuery ){
  ...
  // You can add custom Javascript code right here.
    ...
    (function( jQuery ){
  var $module = jQuery('#m-1701299541894').children('.module');
  ...
  if(mode == 'dev') {
    var moduleId = "1701299541894";
    var moduleIdSlug = moduleId.toString().replace(/-/g, '');
    if (moduleIdSlug == "1701299541894") {
      window.getTab1701299541894 = function() {
    ...
    (function( jQuery ){
  var $module = jQuery('#m-1701299565613').children('.module');
  $module.gfV1Popup();

  var mode = jQuery('.gryffeditor').hasClass('editing') ? 'dev' : 'production';
  if(mode == 'dev') {
    var moduleId = "1701299565613";
    var moduleIdSlug = moduleId.toString().replace(/-/g, '');
    if (moduleIdSlug == "1701299565613") {
      window.getPopup1701299565613 = function() {
