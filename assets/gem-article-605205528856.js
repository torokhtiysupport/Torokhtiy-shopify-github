...
(function( jQuery ){
  ...
  // You can add custom Javascript code right here.
    ...
    (function( jQuery ){
  var $module = jQuery('#m-1701300485203').children('.module');
  ...
  if(mode == 'dev') {
    var moduleId = "1701300485203";
    var moduleIdSlug = moduleId.toString().replace(/-/g, '');
    if (moduleIdSlug == "1701300485203") {
      window.getTab1701300485203 = function() {
    ...
    (function( jQuery ){
  var $module = jQuery('#m-1701300508045').children('.module');
  $module.gfV1Popup();

  var mode = jQuery('.gryffeditor').hasClass('editing') ? 'dev' : 'production';
  if(mode == 'dev') {
    var moduleId = "1701300508045";
    var moduleIdSlug = moduleId.toString().replace(/-/g, '');
    if (moduleIdSlug == "1701300508045") {
      window.getPopup1701300508045 = function() {
