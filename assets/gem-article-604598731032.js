...
$(document).on("inview", ".rate_bar_wrap", function(event, visible) {
    ...
    (function( jQuery ){
  // var $module = jQuery('#m-1674650818372').children('.module');
  // You can add custom Javascript code right here.
})( window.GemQuery || jQuery );
  ...
  // You can add custom Javascript code right here.
    ...
    (function( jQuery ){
  var $module = jQuery('#m-1701126665813').children('.module');
  ...
  if(mode == 'dev') {
    var moduleId = "1701126665813";
    var moduleIdSlug = moduleId.toString().replace(/-/g, '');
    if (moduleIdSlug == "1701126665813") {
      window.getTab1701126665813 = function() {
    ...
    (function( jQuery ){
  var $module = jQuery('#m-1701126732973').children('.module');
  $module.gfV1Popup();

  var mode = jQuery('.gryffeditor').hasClass('editing') ? 'dev' : 'production';
  if(mode == 'dev') {
    var moduleId = "1701126732973";
    var moduleIdSlug = moduleId.toString().replace(/-/g, '');
    if (moduleIdSlug == "1701126732973") {
      window.getPopup1701126732973 = function() {
