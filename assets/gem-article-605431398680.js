...
(function( jQuery ){
  // var $module = jQuery('#m-1687198214740').children('.module');
  // You can add custom Javascript code right here.
})( window.GemQuery || jQuery );
    ...
    (function( jQuery ){
  var $module = jQuery('#m-1701433228594').children('.module');
  ...
  if(mode == 'dev') {
    var moduleId = "1701433228594";
    var moduleIdSlug = moduleId.toString().replace(/-/g, '');
    if (moduleIdSlug == "1701433228594") {
      window.getTab1701433228594 = function() {
    ...
    (function( jQuery ){
  var $module = jQuery('#m-1701433274434').children('.module');
  $module.gfV1Popup();

  var mode = jQuery('.gryffeditor').hasClass('editing') ? 'dev' : 'production';
  if(mode == 'dev') {
    var moduleId = "1701433274434";
    var moduleIdSlug = moduleId.toString().replace(/-/g, '');
    if (moduleIdSlug == "1701433274434") {
      window.getPopup1701433274434 = function() {
