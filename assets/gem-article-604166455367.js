    ...
    (function( jQuery ){
  // var $module = jQuery('#m-1658815896207').children('.module');
...
(function( jQuery ){
  // var $module = jQuery('#m-1698579909372').children('.module');
  // You can add custom Javascript code right here.
})( window.GemQuery || jQuery );
    
(function( jQuery ){
  // var $module = jQuery('#m-1698579909373').children('.module');
  // You can add custom Javascript code right here.
})( window.GemQuery || jQuery );
    ...
    (function( jQuery ){
  // var $module = jQuery('#m-1698579909151').children('.module');
  // You can add custom Javascript code right here.
})( window.GemQuery || jQuery );
    ...
    (function( jQuery ){
  var $module = jQuery('#m-1698579909389').children('.module');
  ...
  if(mode == 'dev') {
    var moduleId = "1698579909389";
    var moduleIdSlug = moduleId.toString().replace(/-/g, '');
    if (moduleIdSlug == "1698579909389") {
      window.getTab1698579909389 = function() {
    ...
    (function( jQuery ){
  var $module = jQuery('#m-1698574025398').children('.module');
  $module.gfV1Popup();

  var mode = jQuery('.gryffeditor').hasClass('editing') ? 'dev' : 'production';
  if(mode == 'dev') {
    var moduleId = "1698574025398";
    var moduleIdSlug = moduleId.toString().replace(/-/g, '');
    if (moduleIdSlug == "1698574025398") {
      window.getPopup1698574025398 = function() {
