...
$(document).on("inview", ".rate_bar_wrap", function(event, visible) {
  ...
  // You can add custom Javascript code right here.
    ...
    (function( jQuery ){
  var $module = jQuery('#m-1701297131689').children('.module');
  ...
  if(mode == 'dev') {
    var moduleId = "1701297131689";
    var moduleIdSlug = moduleId.toString().replace(/-/g, '');
    if (moduleIdSlug == "1701297131689") {
      window.getTab1701297131689 = function() {
    ...
    (function( jQuery ){
  var $module = jQuery('#m-1701297141330').children('.module');
  $module.gfV1Popup();

  var mode = jQuery('.gryffeditor').hasClass('editing') ? 'dev' : 'production';
  if(mode == 'dev') {
    var moduleId = "1701297141330";
    var moduleIdSlug = moduleId.toString().replace(/-/g, '');
    if (moduleIdSlug == "1701297141330") {
      window.getPopup1701297141330 = function() {
