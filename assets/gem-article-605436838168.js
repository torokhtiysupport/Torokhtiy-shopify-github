...
(function( jQuery ){
  ...
  // You can add custom Javascript code right here.
    ...
    (function( jQuery ){
  var $module = jQuery('#m-1701432893495').children('.module');
  ...
  if(mode == 'dev') {
    var moduleId = "1701432893495";
    var moduleIdSlug = moduleId.toString().replace(/-/g, '');
    if (moduleIdSlug == "1701432893495") {
      window.getTab1701432893495 = function() {
    ...
    (function( jQuery ){
  var $module = jQuery('#m-1701432931787').children('.module');
  $module.gfV1Popup();

  var mode = jQuery('.gryffeditor').hasClass('editing') ? 'dev' : 'production';
  if(mode == 'dev') {
    var moduleId = "1701432931787";
    var moduleIdSlug = moduleId.toString().replace(/-/g, '');
    if (moduleIdSlug == "1701432931787") {
      window.getPopup1701432931787 = function() {
