...
$(document).on("inview", ".rate_bar_wrap", function(event, visible) {
    ...
    (function( jQuery ){
  // var $module = jQuery('#m-1698235468288').children('.module');
...
(function( jQuery ){
  // var $module = jQuery('#m-1698248920042').children('.module');
  // You can add custom Javascript code right here.
})( window.GemQuery || jQuery );
    
(function( jQuery ){
  // var $module = jQuery('#m-1698248920044').children('.module');
  // You can add custom Javascript code right here.
})( window.GemQuery || jQuery );
    ...
    (function( jQuery ){
  var $module = jQuery('#m-1698241950102').children('.module');
  ...
  if(mode == 'dev') {
    var moduleId = "1698241950102";
    var moduleIdSlug = moduleId.toString().replace(/-/g, '');
    if (moduleIdSlug == "1698241950102") {
      window.getTab1698241950102 = function() {
    ...
    (function( jQuery ){
  var $module = jQuery('#m-1698242087905').children('.module');
  $module.gfV1Popup();

  var mode = jQuery('.gryffeditor').hasClass('editing') ? 'dev' : 'production';
  if(mode == 'dev') {
    var moduleId = "1698242087905";
    var moduleIdSlug = moduleId.toString().replace(/-/g, '');
    if (moduleIdSlug == "1698242087905") {
      window.getPopup1698242087905 = function() {
