...
(function( jQuery ){
  // var $module = jQuery('#m-1665145580046').children('.module');
  // You can add custom Javascript code right here.
    ...
    (function( jQuery ){
  // var $module = jQuery('#m-1668020090701').children('.module');
  // You can add custom Javascript code right here.
})( window.GemQuery || jQuery );
  
(function( jQuery ){
  // var $module = jQuery('#m-1665262343959').children('.module');
  // You can add custom Javascript code right here.
})( window.GemQuery || jQuery );
    ...
    (function( jQuery ){
  // var $module = jQuery('#m-1673713037336').children('.module');
  // You can add custom Javascript code right here.
})( window.GemQuery || jQuery );
    ...
    (function( jQuery ){
  var $module = jQuery('#m-1701196361943').children('.module');
  ...
  if(mode == 'dev') {
    var moduleId = "1701196361943";
    var moduleIdSlug = moduleId.toString().replace(/-/g, '');
    if (moduleIdSlug == "1701196361943") {
      window.getTab1701196361943 = function() {
    ...
    (function( jQuery ){
  var $module = jQuery('#m-1701197989050').children('.module');
  $module.gfV1Popup();

  var mode = jQuery('.gryffeditor').hasClass('editing') ? 'dev' : 'production';
  if(mode == 'dev') {
    var moduleId = "1701197989050";
    var moduleIdSlug = moduleId.toString().replace(/-/g, '');
    if (moduleIdSlug == "1701197989050") {
      window.getPopup1701197989050 = function() {
